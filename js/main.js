...
async function loadMusicList() {
  ...
  songsContainer.innerHTML =
    '<div class="loading"><i class="fas fa-spinner fa-spin"></i> 加载音乐中...</div>';
  ...
  try {
    ...
    if (musicData) {
      ...
      // 如果没有URL参数，显示提示信息
      songsContainer.innerHTML =
        '<div class="no-songs"><i class="fas fa-music"></i> 暂无音乐，<a href="upload.html">上传第一首歌曲</a></div>';
      return;
    }
      ...
      songCard.innerHTML = `
        ...
        <div class="song-info">
          ...
          <div class="song-actions">
            ...
            <a href="${song.url}" download="${song.title}.${getFileExtension(
        song.fileName
